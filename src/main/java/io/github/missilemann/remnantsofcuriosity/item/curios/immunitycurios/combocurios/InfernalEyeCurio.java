...
public class InfernalEyeCurio extends ImmunityCurio {
    public InfernalEyeCurio(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> list, TooltipFlag flagIn) {
        RemnantItem.addLocalizedString(list, "tooltip.remnantsofcuriosity.infernaleyeinfo", ChatFormatting.BOLD, ChatFormatting.GOLD);
        ...
        if (Screen.hasShiftDown()) {
            ...
            RemnantItem.addLocalizedString(list, "tooltip.remnantsofcuriosity.immuneblindness", ChatFormatting.ITALIC, ChatFormatting.AQUA);
