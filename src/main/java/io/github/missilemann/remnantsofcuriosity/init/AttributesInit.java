...
public class AttributesInit {
    ...
    public static final RegistryObject<Attribute> BLAST_IMMUNITY = registerAttribute("blast_immunity",(id) -> new RangedAttribute(id, 0.0D,0.0D,10.0D).setSyncable(true),"4991f807-d3b9-48e5-9ed3-5a45102d3a4a");
    public static final RegistryObject<Attribute> MAGIC_IMMUNITY = registerAttribute("magic_immunity",(id) -> new RangedAttribute(id, 0.0D,0.0D,10.0D).setSyncable(true),"517b3edf-d237-411f-9316-2fb08e5b4dc1");
    public static final RegistryObject<Attribute> PROJECTILE_IMMUNITY = registerAttribute("projectile_immunity",(id) -> new RangedAttribute(id, 0.0D,0.0D,10.0D).setSyncable(true),"4f221d27-d71c-4f86-b4ea-6de8e41323f3");
